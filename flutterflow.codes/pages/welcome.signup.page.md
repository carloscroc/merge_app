...
import 'welcome_sign_up_page_model.dart';
export 'welcome_sign_up_page_model.dart';

class WelcomeSignUpPageWidget extends StatefulWidget {
  const WelcomeSignUpPageWidget({super.key});

  static String routeName = 'WelcomeSignUpPage';
  static String routePath = '/welcomeSignUpPage';
...
class _WelcomeSignUpPageWidgetState extends State<WelcomeSignUpPageWidget> {
  late WelcomeSignUpPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WelcomeSignUpPageModel());
  }
